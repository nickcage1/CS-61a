...
def free_bacon(score):
    ...
    if score == 0:
        return 6
    pi = pi // pow(10, 100 - score) % pow(10, score)
    while pi > 10:
            pi = pi % 10
    return pi + 3
    # END PROBLEM 2
...
def swine_align(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4a
    a = 1
    while a <= (player_score and opponent_score):
        if (player_score % a == 0 and opponent_score % a == 0) and a >= 10:
            return True
        a += 1
    return False
# END PROBLEM 4a
...
def pig_pass(player_score, opponent_score):
    ...
    """
    # BEGIN PROBLEM 4b
    yay = player_score - opponent_score
    if yay < 0 and yay > -3:
        return True
    return False
    # END PROBLEM 4b
    ...
    def say(score0 , score1):
        if who == 0:
            if last_score == 0:
                last_score2 = score0
                running_high2 = 0
                if score0 > running_high2:
                    print (score0, 'point(s)! The most yet for Player 0')
                    running_high2 = score0
            else:
                increase = score0 - last_score
                last_score2 = score0
                running_high2 = running_high
                if increase > running_high:
                    print (increase, 'point(s)! The most yet for Player 0')
                    running_high2 = increase
            return announce_highest(0, last_score2, running_high2)
        elif who == 1:
            if last_score == 0:
                last_score2 = score1
                running_high2 = 0
                if score1 > running_high2:
                    print (score1, 'point(s)! The most yet for Player 1')
                    running_high2 = score1
            else:
                ...
                if increase > running_high:
                    ...
                    running_high2 = increase
            return announce_highest(1 , last_score2, running_high2)
    return say
    # END PROBLEM 7
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    """
    # BEGIN PROBLEM 9
    """def average_rolls (*args):"""
    s = 1
    best_roll_average = 0
    best_dice = 0
    current_roll_average = 0
    while s <= 10:
        averaged_roll_dice = make_averaged (roll_dice, trials_count)
        current_roll_average = averaged_roll_dice (s , dice)
        if current_roll_average > best_roll_average:
            best_dice = s
            best_roll_average = current_roll_average
        s = s + 1
    return best_dice
...
def bacon_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    bacon_value = free_bacon (opponent_score)
    if bacon_value >= cutoff:
        return 0
    else:
        return num_rolls
    # END PROBLEM 10
